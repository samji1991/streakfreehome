...
global $product;
?>
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo intval($product_id); ?> wishlist-btn<?php echo ( $exists && ! $available_multi_wishlist ) ? ' wishlist-added' : '' ?>">
	...
	<?php if( ! ( $disable_wishlist && ! is_user_logged_in() ) ): ?>
	    ...
	    <div class="yith-wcwl-wishlistaddedbrowse hide" style="display:none;">
	        <a href="<?php echo esc_url( $wishlist_url )?>" rel="nofollow">
	            ...
	            <span class="wishlist-btn-label"><?php echo apply_filters( 'yith-wcwl-browse-wishlist-label', $browse_wishlist_text )?></span>
	        </a>
	    </div>
	...
	<?php else: ?>
		<a href="<?php echo esc_url( add_query_arg( array( 'wishlist_notice' => 'true', 'add_to_wishlist' => $product_id ), get_permalink( wc_get_page_id( 'myaccount' ) ) ) )?>" rel="nofollow" class="<?php echo esc_html(str_replace( 'add_to_wishlist', '', $link_classes )); ?>" >
			<i class="fa fa-heart"></i>
