...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="cart-items-wrap">
		<table class="cart-items">
			<thead>
			<tr>
				<td class="cart-image"><?php esc_html_e('Photo', 'allstore'); ?></td>
				<td class="cart-ttl"><?php esc_html_e('Products', 'allstore'); ?></td>
				<td class="cart-price"><?php esc_html_e('Price', 'allstore'); ?></td>
				<td class="cart-quantity"><?php esc_html_e('Quantity', 'allstore'); ?></td>
				<td class="cart-summ"><?php esc_html_e('Summ', 'allstore'); ?></td>
	...
	<div class="cart-submit">
		...
		<input type="submit" class="button" name="update_cart" value="<?php esc_attr_e( 'Update Cart', 'allstore' ); ?>" />
